...
- Dispatch every agent that produces file changes for a deliverable piece of work with `isolation: "worktree"` — one worktree per piece, team or not. Collect each worktree's diff and integrate it into the main tree yourself.
